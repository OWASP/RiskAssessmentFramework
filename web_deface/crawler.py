...
class Crawler(object):
    ...
    def __init__(self,
        ...
        self.CRAWLED_FILE_PATH = 'crawled.txt'
    ...
    def crawl(self, pb):
        ...
        try:
            ...
            print("[+] Keyboard Interrupt, stopping crawling")
        except Exception as e:
            print("[-] Error occured: " + str(e))
    ...
    def threading_crawl(self):
        ...
        print("[!] Started crawling: {0}".format(self.url))
        try:
            ...
            print('[!] Exiting...')
            print("[-] Keyboard Interrupt, stopping threaded crawling")
        except Exception as e:
            print("[-] Error occured: " + str(e))
